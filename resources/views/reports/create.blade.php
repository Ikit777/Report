                        ...
                        <tr class="{{ $isAvgRow ? 'average-row' : '' }}">
                            ...
                            <td>
                                <input type="number" 
                                       ...
                                       data-main-hole="{{ $tank->main_hole }}"
                                       data-type="fm_pakai" 
                                       value="{{ old("items.{$index}.fm_pakai", '') }}" 
                                       readonly>
                            </td>
                ...
                <tbody id="flowmeterRows">
                    @for($i = 0; $i < max(1, count(old('flowmeters', []))); $i++)
                        <tr>
                            ...
                            <td>
                                <input type="text" name="flowmeters[{{ $i }}][jenis_flowmeter]" class="sheet-input read-only flowmeter-jenis-input" data-index="{{ $i }}" readonly value="{{ old("flowmeters.{$i}.jenis_flowmeter") }}">
                            </td>
                            <td>
                                <input type="text" name="flowmeters[{{ $i }}][nomor_seri]" class="sheet-input read-only flowmeter-nomor-input" data-index="{{ $i }}" readonly value="{{ old("flowmeters.{$i}.nomor_seri") }}">
                            </td>
                            <td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const handleAvgMainHoleTank = (row) => {
        ...
        console.log('Creating BELAKANG row', { belakangIndex, tankId: select.value });
        ...
        console.log('Created hidden input for BELAKANG', {
            name: belakangHiddenInput.name,
            value: belakangHiddenInput.value,
            parentCell: belakangMainHoleCell.className,
            stillInDom: document.contains(belakangHiddenInput)
        });
        ...
        console.log('Creating average row', { avgIndex, tankId: select.value });
        ...
        console.log('Created hidden input for average', {
            name: avgHiddenInput.name,
            value: avgHiddenInput.value,
            parentCell: avgMainHoleCell.className,
            stillInDom: document.contains(avgHiddenInput)
        });
