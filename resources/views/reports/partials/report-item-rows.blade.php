...
<tbody id="reportItemRows">
    @for($i = 0; $i < $itemRowCount; $i++)
        ...
        <tr>
            ...
            <td><input type="text" name="items[{{ $i }}][liter_pagi]" class="sheet-input read-only" data-item-type="liter_pagi" value="{{ old("items.{$i}.liter_pagi", Auth::user()->isFuelman() ? 'XXXX' : ($savedItem?->liter_pagi ?? '')) }}" readonly></td>
            ...
            <td><input type="text" name="items[{{ $i }}][liter_sore]" class="sheet-input read-only" data-item-type="liter_sore" value="{{ old("items.{$i}.liter_sore", Auth::user()->isFuelman() ? 'XXXX' : ($savedItem?->liter_sore ?? '')) }}" readonly></td>
            ...
            <td><input type="number" name="items[{{ $i }}][fm_pakai]" class="sheet-input read-only" data-item-type="fm_pakai" value="{{ old("items.{$i}.fm_pakai", $savedItem?->fm_pakai) }}" readonly></td>
